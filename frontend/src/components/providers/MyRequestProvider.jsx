    ...
    {requests.map((req) => {
      ...
      return (
        <div key={req._id} className="bg-white border border-gray-200 rounded-lg p-5 mb-5 shadow-sm">
          ...
          {req.status === "en_curso" && (
            <div className="mt-3">
              ...
              <div className="bg-gray-50 p-3 rounded-md mt-3">
                ...
                <p>Servicio: {req.details.name_service}</p>
                <p>Descripción: {req.details.decription}</p>
          ...
          {req.status === "creada" && (
            <div className="mt-3">
              <p className="text-blue-600 font-bold">Nueva solicitud recibida</p>
            </div>
          )}
          ...
          {req.status === "pendiente" && (
            <div className="mt-3">
              <p className="text-yellow-500 font-bold">
                Falta que el cliente llene el formulario de confirmación
              </p>
            </div>
          )}
